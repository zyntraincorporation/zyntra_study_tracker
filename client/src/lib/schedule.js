// Client-side mirror of the schedule — used for UI without API roundtrip
...
export const SUBJECTS = ['Physics', 'Chemistry', 'Math', 'Botany', 'Zoology', 'ICT', 'Other'];
...
export const SUBJECT_COLORS = {
  ...
  ICT:       { bg: 'bg-orange-500/15',  text: 'text-orange-400',  dot: 'bg-orange-400',  hex: '#fb923c' },
  Other:     { bg: 'bg-white/10',       text: 'text-white/60',    dot: 'bg-white/40',    hex: '#94a3b8' },
};

export const DAY_NAMES = ['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'];

// BST helpers on the client
